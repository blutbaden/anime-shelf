...
@section('page-title', __('Edit Studio'))
@section('content')
<div class="max-w-2xl">
    ...
    @endif
    <form action="{{ route('studios.update', $studio->id) }}" method="POST" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-5">
        @csrf @method('PUT')
        @include('admin.studios._form', ['studio' => $studio])
