...
@section('page-title', __('Add Anime'))
...
<div class="max-w-4xl">
    ...
    <form action="{{ route('animes.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @include('admin.animes._form')
        <div class="flex gap-3">
            <button type="submit" class="px-6 py-2.5 bg-anime-600 hover:bg-anime-700 text-white font-semibold rounded-lg text-sm">{{ __('Create Anime') }}</button>
